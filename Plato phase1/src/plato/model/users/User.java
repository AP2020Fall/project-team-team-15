...
public class User {
    ...
    public User(String name, String family,String email, String phone_number) {
        this.name = name;
        this.family = family;
        this.email = email;
    ...
    public User(String name, String family, String username, String password, String email, String phone_number) {
        this.name = name;
        this.family = family;
        this.username = username;
        this.password = password;
